...
public:
    ...
    /** @brief Returns the precomputed factor by which the maximum speed of the vehicle is multiplied
     * @return Maximum speed factor
     */
    inline double getChosenBikeFactor() const {
        return myChosenBikeFactor;
    }

    /// @brief Sets the precomputed factor by which the maximum speed of the vehicle is multiplied

    inline void setChosenBikeFactor(const double factor) {
        myChosenBikeFactor = factor;
    }
...
protected:
    ...
    /// @brief A precomputed factor by which the maximum speed of the vehicle is multiplied
    double myChosenBikeFactor;
